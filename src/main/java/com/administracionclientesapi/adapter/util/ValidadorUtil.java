package com.administracionclientesapi.adapter.util;

import com.administracionclientesapi.domain.entity.Cuenta;
import com.administracionclientesapi.domain.exeption.ValidacionDataException;
...
public class ValidadorUtil {
    ...
    public static void validarEdad(LocalDate fechaNacimiento) {
        ...
        if (edad.getYears() < 18) {
            throw new ValidacionDataException("El cliente debe ser mayor de edad");
        }
    }
